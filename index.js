...
const mytoken = process.env.MYTOKEN; //GirishByahatti_token
let phon_no_id;
let from;
...
app.listen(process.env.PORT, () => {
    console.log("Hi GirishByahatti Webhook is active");
});
...
app.post("/", (req, res) => { //i want some 
    ...
    if (body_param.object) {
        ...
        if (body_param.entry &&
            ...
            console.log(" your Message before sending to ODA is ------>" + message);
...
app.get("/", (req, res) => {
    res.status(200).send("Hello GirishByahatti this is webhook setup");
});